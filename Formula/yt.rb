class Yt < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "ddb6cee1542b70f7622b2753133fa76a2b03a166daa1ea5ae1be11d9435459f4"
    end
    on_intel do
  ...
  on_linux do
    on_intel do
      ...
      sha256 "001cda180f16903daa94fccb8932710f0c6033f1be4c357d79be9e3117bc8ff6"
    end
    on_arm do
      url "https://github.com/RoboNET/YandexTrackerCLI/releases/download/v#{version}/yt-linux-arm64.tar.gz"
      sha256 "122ceef5a7068faf185dfcf029478de0dbfabafcb69e922004fee1a1d0b407ac"
    end
  end
